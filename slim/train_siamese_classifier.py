...
def main(_):
  ...
  with tf.Graph().as_default():
    ...
    # Select the dataset #
    ######################
    dataset1 = dataset_factory.get_dataset(
        FLAGS.dataset_name, FLAGS.dataset_split_name, FLAGS.dataset_dir)
    dataset2 = dataset_factory.get_dataset(
        FLAGS.dataset_name, FLAGS.dataset_split_name, FLAGS.dataset_dir)
    ...
    with tf.device(deploy_config.inputs_device()):
      with tf.name_scope('inputs'):
        provider1 = slim.dataset_data_provider.DatasetDataProvider(
            dataset1,
            num_readers=FLAGS.num_readers,
            common_queue_capacity=20 * FLAGS.batch_size,
            common_queue_min=10 * FLAGS.batch_size)
        [x_image, x_label] = provider1.get(['image', 'label'])
        ...
        provider2 = slim.dataset_data_provider.DatasetDataProvider(
            ...
            common_queue_capacity=20 * FLAGS.batch_size,
            common_queue_min=10 * FLAGS.batch_size)
        [y_image, y_label] = provider1.get(['image', 'label'])
