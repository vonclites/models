...
def create_readable_names_for_imagenet_labels():
  ...
  Code is based on
  https://github.com/tensorflow/networks/blob/master/inception/inception/data/build_imagenet_data.py#L463
  """

  # pylint: disable=g-line-too-long
  base_url = 'https://raw.githubusercontent.com/tensorflow/networks/master/inception/inception/data/'
